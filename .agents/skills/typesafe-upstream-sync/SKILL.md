...
1. Initialize `vendor/typesafe-sdk-python` if needed, fetch tags, and verify the requested stable release from GitHub/Git. Compare its exact commit with the recorded basis. If unchanged, leave the working tree unchanged.
